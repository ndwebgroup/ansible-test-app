...
class ReasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reason" do
    assert_difference('Reason.count') do
      post reasons_url, params: { reason: { description: @reason.description, importance: @reason.importance, name: @reason.name } }
    end
  ...
  test "should update reason" do
    patch reason_url(@reason), params: { reason: { description: @reason.description, importance: @reason.importance, name: @reason.name } }
